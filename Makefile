...
# Default target.
all: begin sizebefore maps build sizeafter end
...
convert: convert.C
	g++ $(GENDEPFLAGS) convert.C -o convert

%.h: %.txt convert
	./convert $(MAPS)

maps: chord_map.h mouse_chord_map.h
...
.PHONY : all begin finish end sizebefore sizeafter gccversion \
         maps build elf hex clean clean_list load debug gdb-config
